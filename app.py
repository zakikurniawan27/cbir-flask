...
output_dir = "/the-simpson-flask/set/data"

splitfolders.ratio(input_dir, output=output_dir,seed=1337, ratio=(.9, 0.1))

train_dir = "/the-simpson-flask/set/data/train"
val_dir = "/the-simpson-flask/set/data/val"
test_dir = "/the-simpson-flask/set/data/test"
